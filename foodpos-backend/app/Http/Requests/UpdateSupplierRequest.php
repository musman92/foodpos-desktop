        ...
        return [
            'name' => [
                ...
                Rule::unique('suppliers', 'name')
                    ...
                    ->ignore($supplierId),
                function (string $attribute, mixed $value, \Closure $fail) use ($companyId, $supplierId): void {
                    if (Supplier::nameIsTaken($companyId, is_string($value) ? $value : null, $supplierId)) {
            ...
            'email' => [
                ...
                Rule::unique('suppliers', 'email')
                    ...
                    ->ignore($supplierId),
                function (string $attribute, mixed $value, \Closure $fail) use ($companyId, $supplierId): void {
                    if (Supplier::emailIsTaken($companyId, is_string($value) ? $value : null, $supplierId)) {
            ...
            'phone' => [
                ...
                Rule::unique('suppliers', 'phone')
                    ...
                    ->ignore($supplierId),
                function (string $attribute, mixed $value, \Closure $fail) use ($companyId, $supplierId): void {
                    if (Supplier::phoneIsTaken($companyId, is_string($value) ? $value : null, $supplierId)) {
