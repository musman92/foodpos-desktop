...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Import Variants</h1>
            <p class="mt-1 text-sm text-gray-500">Upload a CSV or Excel file to create or update variants and their options in bulk.</p>
        </div>
    ...
    <div class="rounded-lg border border-indigo-100 bg-indigo-50/60 px-4 py-3 text-sm text-indigo-900">
        ...
        <p class="mt-1 text-indigo-800">Use <strong>one row per option</strong>. Repeat the same <code class="font-mono text-xs bg-white/70 px-1 rounded">variant_code</code> for Size → Small, Medium, Large. Default prices prefill menu items when you attach the variant.</p>
    </div>

    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Download sample file</h2>
            <p class="mt-1 text-sm text-gray-500">Use this template before uploading.</p>
        </div>
        <div class="px-6 py-5 flex flex-wrap gap-3">
            <a href="{{ route('variants.import.sample', ['format' => 'xlsx']) }}"
            ...
            <a href="{{ route('variants.import.sample', ['format' => 'csv']) }}"
               class="inline-flex items-center px-4 py-2 h-11 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Download your variants in the same long-format layout used for import.</p>
        </div>
        <div class="px-6 py-5">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <form action="{{ route('variants.import.store') }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-5">
            @csrf
            <div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <div class="px-6 py-5 overflow-x-auto">
            <table class="listing-table min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">variant_code</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">e.g. V01. Leave blank to auto-assign. Existing code = update that variant.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">variant_name</td>
                        <td class="px-4 py-3 text-gray-600">Yes*</td>
                        <td class="px-4 py-3 text-gray-600">e.g. Size, Crust. Required on the first row of each variant group.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">option_name</td>
                        <td class="px-4 py-3 text-gray-600">Yes</td>
                        <td class="px-4 py-3 text-gray-600">e.g. Small, Medium, Large — one per row.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">option_code</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">e.g. O01. Auto-assigned when blank.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">default_price</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Prefills menu item option prices. Blank = use menu base price later.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">option_sort_order</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Order of options within the variant. Defaults to 0.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">description</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Variant-level description (same on all rows for that variant).</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">variant_sort_order</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Sort order in variant lists. Defaults to 0.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">is_active</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">yes/no, true/false, or 1/0. Defaults to yes.</td>
                    </tr>
                </tbody>
            </table>
        </div>
