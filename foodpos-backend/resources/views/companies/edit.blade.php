...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-xl font-semibold text-gray-900">Edit Company</h1>
            <p class="mt-1 text-sm text-gray-500">Update company information</p>
        </div>
        ...
        <form action="{{ route('companies.update', $company) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="currency" 
                           id="currency" 
                           value="{{ old('currency', $company->currency ?? 'USD') }}"
                           maxlength="3"
            ...
            <div class="flex items-center">
                ...
                <input type="checkbox" name="demo" id="demo" value="1" {{ old('demo', $company->demo) ? 'checked' : '' }}
                       class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                <label for="demo" class="ml-2 block text-sm text-gray-700">Demo company (allow reset to Pizza Shop dataset)</label>
            </div>

            @include('companies._addons')

            @include('companies._billing-fields', ['outstandingBalance' => $outstandingBalance ?? $company->outstandingBalance()])
