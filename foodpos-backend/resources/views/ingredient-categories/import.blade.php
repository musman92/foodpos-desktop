...
@section('title', 'Import Ingredient Categories')

@section('content')
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Import Ingredient Categories</h1>
            <p class="mt-1 text-sm text-gray-500">Upload a CSV or Excel file to create or update ingredient categories in bulk.</p>
        </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Use this template to prepare your ingredient categories before uploading.</p>
        </div>
        <div class="px-6 py-5 flex flex-wrap gap-3">
            <a href="{{ route('ingredient-categories.import.sample', ['format' => 'xlsx']) }}"
            ...
            <a href="{{ route('ingredient-categories.import.sample', ['format' => 'csv']) }}"
               class="inline-flex items-center px-4 py-2 h-11 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <form action="{{ route('ingredient-categories.import.store') }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-5">
            @csrf
            <div>
