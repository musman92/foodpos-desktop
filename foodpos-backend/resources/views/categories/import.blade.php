...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Upload a CSV or Excel file to create or update categories in bulk.</p>
        </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Use this template to prepare your categories before uploading.</p>
        </div>
        <div class="px-6 py-5 flex flex-wrap gap-3">
            <a href="{{ route('categories.import.sample', ['format' => 'xlsx']) }}"
            ...
            <a href="{{ route('categories.import.sample', ['format' => 'csv']) }}"
               class="inline-flex items-center px-4 py-2 h-11 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Download your categories in the same format used for import.</p>
        </div>
        <div class="px-6 py-5">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <form action="{{ route('categories.import.store') }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-5">
            @csrf
            <div>
            ...
            <table class="listing-table min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr>
                        ...
                        <td class="px-4 py-3 text-gray-600">Leave blank to auto-assign C01, C02, etc. If the code already exists, that category is updated.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">name</td>
                        <td class="px-4 py-3 text-gray-600">Yes</td>
                        <td class="px-4 py-3 text-gray-600">Category display name.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">parent_code</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Code of the parent category for subcategories. Parent must be a top-level category.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">description</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Optional description text.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">sort_order</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Number used for ordering (lower appears first). Defaults to 0.</td>
                    </tr>
                    <tr>
