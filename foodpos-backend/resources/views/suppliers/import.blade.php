...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Import Suppliers</h1>
            <p class="mt-1 text-sm text-gray-500">Upload a CSV or Excel file to create or update suppliers in bulk.</p>
        </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Use this template to prepare your suppliers before uploading.</p>
        </div>
        <div class="px-6 py-5 flex flex-wrap gap-3">
            <a href="{{ route('suppliers.import.sample', ['format' => 'xlsx']) }}"
            ...
            <a href="{{ route('suppliers.import.sample', ['format' => 'csv']) }}"
               class="inline-flex items-center px-4 py-2 h-11 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Download your suppliers in the same format used for import.</p>
        </div>
        <div class="px-6 py-5">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <form action="{{ route('suppliers.import.store') }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-5">
            @csrf
            <div>
            ...
            <table class="listing-table min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr>
                        ...
                        <td class="px-4 py-3 text-gray-600">Leave blank to auto-assign SU01, SU02, etc. If the code already exists, that supplier is updated.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">name</td>
                        <td class="px-4 py-3 text-gray-600">Yes</td>
                        <td class="px-4 py-3 text-gray-600">Company name. Must be unique within your company.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">contact_person</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Primary contact at the supplier.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">email</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Optional. When provided, must be unique within your company.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">whatsapp</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">WhatsApp number with country code.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">address</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Supplier address.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">tax_id</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Tax or registration ID.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-3 font-mono text-gray-900">balance</td>
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Opening balance. Positive = you owe the supplier; negative = you prepaid the supplier. Defaults to 0 on create; leave blank on update to keep the current balance.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-gray-600">No</td>
                        <td class="px-4 py-3 text-gray-600">Use active/inactive, yes/no, or 1/0. Defaults to active.</td>
                    </tr>
                </tbody>
            </table>
        </div>
